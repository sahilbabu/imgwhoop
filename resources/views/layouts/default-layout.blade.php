...
<body class="padTop53 " >
        ...
        <div id="top">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
                ...
                <header class="navbar-header">
                    ...
                    <img src="theme_assets/img/logo.png" alt="" />
                                ...
                                <ul class="chat">
                                    <li class="left clearfix">
                                        <span class="chat-img pull-left">
                                            <img src="theme_assets/img/1.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                    ...
                                    <li class="right clearfix">
                                        <span class="chat-img pull-right">
                                            <img src="theme_assets/img/2.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                    ...
                                    <li class="left clearfix">
                                        <span class="chat-img pull-left">
                                            <img src="theme_assets/img/3.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <strong class="primary-font"> Jack Sparrow </strong>
                                    ...
                                    <li class="right clearfix">
                                        <span class="chat-img pull-right">
                                            <img src="theme_assets/img/4.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <small class=" text-muted">
    ...
    <!-- PAGE LEVEL SCRIPTS -->
    <script src="theme_assets/plugins/flot/jquery.flot.js"></script>
    <script src="theme_assets/plugins/flot/jquery.flot.resize.js"></script>
    <script src="theme_assets/plugins/flot/jquery.flot.time.js"></script>
     <script  src="theme_assets/plugins/flot/jquery.flot.stack.js"></script>
    <script src="theme_assets/js/for_index.js"></script>
